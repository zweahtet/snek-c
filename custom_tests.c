...
bool test_is_tail()
{
  ...
  char *testcase_1 = "wasd";
  for (int i = 0; i < strlen(testcase_1); i++)
  {
    if (!assert_true("one of these characters wasd", is_tail(testcase_1[i])))
    {
      return false;
    }
  }
...
{
  // TODO: Implement this function.
  char *testcase_1 = "WASDx";
  for (int i = 0; i < strlen(testcase_1); i++)
  {
    if (!assert_true("one of these characters WASDx", is_head(testcase_1[i])))
    {
      return false;
    }
  }
...
{
  // TODO: Implement this function.
  char *testcase_1 = "wasd^<v>WASDx";
  for (int i = 0; i < strlen(testcase_1); i++)
  {
    if (!assert_true("one of these characters wasd^<v>WASDx", is_snake(testcase_1[i])))
    {
      return false;
    }
  }
